  ...
  <section class="parallax-window" id="home" data-parallax="scroll" data-image-src="img/sub_header_cart.jpg" data-natural-width="1400" data-natural-height="350">
   ...
   <div id="subheader">
      ...
      <div id="sub_content">
        ...
        <h2 style="color: #fff; font-size: 25px !important">Encontre aqui: <strong id="js-rotating"><b></b>Restaurantes,Lanchonetes,Hamburguerias,Pizzarias,Sorveterias, e muito mais</b></strong> !</h2>
        <p>
